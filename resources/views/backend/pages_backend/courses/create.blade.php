                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"  name="course_name" id="validationCustom02" placeholder="Enter course name" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- row --}}
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" class="form-control" name="course_photo" id="validationCustom05" placeholder="" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="validationCustom02">Price range</label>
                                                        <input type="text" class="form-control"  name="course_price_range" id="validationCustom02" placeholder="Enter range i.e (1000000 - 1200000)" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
