                            ...
                            <center>
                                <div class="courses-item">
                                    ...
                                    <div class="content-part">
                                        ...
                                        <ul class="meta-part">
                                            <li>
                                                <p style="margin-bottom:-1px;">{{ $dental_course->course_level }}</p>
                                            </li>
                                            <li><span class="price">UGX. {{ $dental_course->course_price_range }} </span>
                                            </li>
                                        </ul>

                                        <h3 class="title"><a href="#">{{ $dental_course->course_name }}</a></h3>
                                        <a href="{{ route('dental.show', $dental_course->id) }}"> View Details <i
